...
permalink: /cv/
author_profile: true
excerpt: "Curriculum vitae of Jens d'Hondt: PhD in computer science from TU Eindhoven, postdoc at the Barcelona Supercomputing Center, publications, talks and service."
redirect_from:
  - /resume
---
...
A PDF version of my CV is available [here]({{ base_path }}/files/postdoc25.pdf). My papers are listed with abstracts on the [publications page]({{ base_path }}/publications/), and slides and recordings on the [talks page]({{ base_path }}/talks/).
