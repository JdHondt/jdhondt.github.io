...
excerpt: 'A comprehensive survey of over 100 time-series distance measures across 7 categories, covering distinctions and applications for both univariate and multivariate time series.'
date: 2024-12-28
venue: 'ArXiv'
slidesurl: #
paperurl: 'https://arxiv.org/abs/2412.20574'
citation: # TODO: add the correct citation for this survey (the previous commented-out one referenced a different paper)
---
